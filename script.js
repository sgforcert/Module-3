...
const collectEmployees = function() {
  ...
  while (continueData) {
    ...
    continueData = confirm("Do you want to add another employee?")     
 }  return employeeData;
}
...
const displayAverageSalary = function(employeesArray) {
  ...
  console.log(`The sum salary is : $${sum}`) 

  const averageSalary = (sum / employeesArray.length).toFixed(2);
  const totalEmployees = employeesArray.length;
  console.log(`The average salary between our ${totalEmployees} employee(s) is $${averageSalary}`); 
